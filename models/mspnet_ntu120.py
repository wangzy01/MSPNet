...
class Primo(CLIP):
    def __init__(self,
        ...
        self.id_classifier = nn.Linear(embed_dim, 106)
    ...
    def forward(self, image_1,image_2, image_3,text):
        ...
        id_logits = self.id_classifier(video_features)

        return logits , id_logits#, video_features, feature1, feature2 #id_logits
