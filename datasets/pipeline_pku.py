...
class Load_IFNS:
    ...
    def __call__(self, results):
        ...
        video_3 = os.path.join("/data2/Real60/Real60_all_avg_resize", os.path.basename(video))
        ...
        if self.train:
            for jj in range(num_clips):
                ...
                frame_1 = load_frame(video, max(1, iii - 1))
        ...
        if ff < self.num_clips:
            frame_idx = last_idx
            frame_1 = load_frame(video, max(1, frame_idx - 1))
